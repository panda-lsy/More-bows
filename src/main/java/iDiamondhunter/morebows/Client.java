...
public final class Client implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        for (final Item bow : MoreBows.getAllItems()) {
            FabricModelPredicateProviderRegistry.register(bow, new Identifier("pull"), (stack, world, entity, seed) -> (entity == null ? 0.0F : entity.getActiveItem() != stack ? 0.0F : (stack.getMaxUseTime() - entity.getItemUseTimeLeft()) / ((CustomBow) stack.getItem()).powerDiv));
